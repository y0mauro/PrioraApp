...
const Logo
  = () => {
    return (
      <div className='text-accent text-3xl font-bold cursor-pointer flex'>

        <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" fill="currentColor" viewBox="0 0 34 34">
